...
public class WeiboListAdapter extends BaseAdapter {
	...
	public WeiboListAdapter(Context context, List<Statuse> statuses) {
		super();
	...
	private void bindView(int position, View view) {
		...
		// 处理微博内容
		//holder.txt_wb_item_content.setMovementMethod(new LinkMovementMethod());//开始响应点击事件
		//holder.txt_wb_item_content.setFocusable(false);
		SimpleWeiboManager.display(holder.txt_wb_item_content, statuse.getText(), context);
		holder.txt_wb_item_content.setHighlightColor(Color.BLUE);
		...
		if (statuse.getRetweeted_status() != null)
		{
			...
			//holder.txt_wb_item_subcontent.setMovementMethod(new LinkMovementMethod());//开始响应点击事件
			//holder.txt_wb_item_subcontent.setFocusable(false);
