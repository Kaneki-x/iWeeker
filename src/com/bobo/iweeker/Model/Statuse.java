...
public class Statuse implements Serializable{
    ...
    private String[] pic_urls; // 原始图片地址，没有时不返回此字段
    private Geo geo; // 地理信息字段 详细
    private User user; // 微博作者的用户信息字段
    private Statuse retweeted_status; // 被转发的原微博信息字段，当该微博为转发微博时返回 详细
    ...
    public Statuse(String created_at, int id, int mid, String idstr, String text, String source,
            boolean favorited, boolean truncated, String in_reply_to_status_id,
            String in_reply_to_user_id, String in_reply_to_screen_name, String thumbnail_pic,
            String bmiddle_pic, String original_pic, String[] pic_urls, Geo geo, User user,
            Statuse retweeted_status, int reposts_count, int comments_count, int attitudes_count,
            int mlevel) {
        super();
